    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtitle_list', models.CharField(blank=True, default='', max_length=100, verbose_name='文章目录')),
        ...
        migrations.AddField(
            model_name='article',
            name='tags',
            field=taggit.managers.TaggableManager(blank=True, help_text='(选填)用英文输入法逗号或空格来分隔标签', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='标签集'),
        ),
    ]
